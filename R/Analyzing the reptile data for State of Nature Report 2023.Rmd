...
# Reptile data:
#load("../data/processed/wrangled_reptile_data_T0-T4.Rdata") #load the wrangled data

reptiles <- readRDS("../data/processed/wrangled_reptile_data_T0-T4.rds")

#reptiles <- fread("../data/processed/wrangled reptile data T0-T4.csv")
#
...
# cols_to_factor <- c("unit", "campaign", "site", "point_name", "settlements", "acriculture", "habitat", "dunes", "heb_name")
# 
# # Apply as.factor() to the specified columns
# reptiles[cols_to_factor] <- lapply(reptiles[cols_to_factor], as.factor)
# 
# cols_to_numeric <- c("year", "mean_lat", "mean_lon", "count_individuals")
# reptiles[cols_to_factor] <- lapply(reptiles[cols_to_numeric], as.numeric)
...
Count the number of surveys per unit and the overall number of surveys:
```{r data summary}
cat("Survey years: ", reptiles[, min(year)], "-", reptiles[, max(year)], "\n")
cat("The total number of surveys is", reptiles[, uniqueN(survey_ID)], "\n") # total number of surveys
cat("The total number of plots is", reptiles[, uniqueN(point_name)], "\n") # Total number of plots
cat("Number of survey campaigns per unit: ")
reptiles[, .(no.of.campaigns = uniqueN(campaign)), keyby = unit]
cat("Number of observations:", reptiles[!is.na(SciName), .N], "\n")
cat("Total number of individuals:", reptiles[, sum(count_individuals)], "\n")
cat("Total number of species:", reptiles[!is.na(SciName), uniqueN(SciName)])
```
...
Species per site:
```{r}
sp.per.site <- reptiles[!is.na(SciName), .(total.abundance = sum(count_individuals), no.of.surveys.found = uniqueN(survey_ID)), keyby = .(unit, site, SciName, heb_name)]
sp.per.site
write_excel_csv(sp.per.site, "../output/Reptile species per site.csv")
dcast(sp.per.site, heb_name ~ unit + site, fun.aggregate = sum, value.var = "total.abundance")
write_excel_csv(dcast(sp.per.site, heb_name ~ unit + site, fun.aggregate = sum, value.var = "total.abundance"), "../output/Reptile species per site - cast.csv")
```
...
png('../output/Coastal Plain species richness QQ plot.png') # Export the QQ plot
...
```{r}
file.remove('../output/Coastal Dunes - species richness model selection.txt')
for (model in c(ls()[grep('*coast.sp.rich.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                 file = '../output/Coastal Dunes - species richness model selection.txt', append = T)
}
# load('../output/Coast Dunes - Species richness models.Rdata')
save(list = ls()[grep('*coast.sp.rich.model', ls())], file = '../output/Coast Dunes - Species richness models.Rdata') # back up the models
...
write_excel_csv(sp.rich.comparison, file = '../output/Species richness models of reptiles - AIC comparison.csv')
```
...
coast.abnd.dotplot
ggsave('../output/Reptile Total Abundance in the coastal sands - dotplot.png', plot = coast.abnd.dotplot)
...
ggsave('../output/Coastal Sands total reptile abundance - observations.png')
```
...
# Export these graphs:
png('../output/Coastal Plain abundance model 5 QQ Plot.png')
plot(coast.abnd.sim.res)
dev.off()

png('../output/Coastal Plain abundance model 5 - DHARMa predicted response vs scaled residuals.png')
plot(coast.abnd.sim.res$fittedPredictedResponse, coast.abnd.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nCoastl Plain abundance model 5') 
dev.off()
png('../output/Coastal Plain abundance model 5 -  fitted values vs residuals.png')
...
```{r}
file.remove('../output/Coastal Dunes - total abundance model selection.txt')
for (model in c(ls()[grep('*coast.total.abnd.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                 file = '../output/Coastal Dunes - total abundance model selection.txt', append = T)
}
# load('output/Coast Dunes - total abundance models.Rdata')
save(list = ls()[grep('*coast.total.abnd.model', ls())], file = '../output/Coast Dunes - total abundance models.Rdata')
...
write_excel_csv(total.abnd.comparison, file = '../output/Coastal Dunes total abundance models of reptiles - AIC comparison.csv')
...
#quantile(reptiles[unit == 'Coastal Plain Sands', .(Time = as.numeric((unique(ITime))), by = survey_ID][, Time])
...
ggsave('../output/coast.total.abnd.model5 seasonal Predictions and observations in reptile total abundance in the Coastal Sand Dunes.png')
```
...
# Export these graphs:
png('../output/Inland Sands species richness model 5 QQ Plot.png')
plot(inland.sands.sp.rich.sim.res)
dev.off()

png('../output/Inland Sands species richness model fitted vs. scaled residuals.png')
plot(inland.sands.sp.rich.sim.res$fittedPredictedResponse, inland.sands.sp.rich.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nInland Sands species richness model 5')
dev.off()

png('../output/Inland Sands species richness model 5 fitted vs. residuals.png')
plot(fitted(inland.sands.sp.rich.model5), residuals(inland.sands.sp.rich.model5), main = 'Response scale residuals\nInland Sands species richness model 5')
dev.off()
```
...
```{r}
file.remove('../output/Inner sands - species richness model selection.txt')
for (model in c(ls()[grep('*inland.sands.sp.rich.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                 file = '../output/Inner sands - species richness model selection.txt', append = T)
}
# load('output/Inner sands - Species richness models.Rdata')
save(list = ls()[grep('*inland.sands.sp.rich.model', ls())], file = '../output/Inner sands - Species richness models.Rdata')
...
# Export these graphs:
png('../output/Inland Sands abundance model 5 QQ Plot.png')
plot(inland.sands.abnd.sim.res)
dev.off()

png('../output/Inland Sands abundance model fitted vs. scaled residuals.png')
plot(inland.sands.abnd.sim.res$fittedPredictedResponse, inland.sands.abnd.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nInland Sands abundance model 5')
dev.off()

png('../output/Inland Sands abundance model 5 fitted vs. residuals.png')
plot(fitted(inland.sands.total.abnd.model6), residuals(inland.sands.total.abnd.model6), main = 'Response scale residuals\nInland Sands abundance model 5')
dev.off()
```
...
file.remove('../output/inland.sandsal Dunes - total abundance model selection.txt')
for (model in c(ls()[grep('*inland.sands.total.abnd.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                                                   file = '../output/inland sands - total abundance model selection.txt', append = T)
}
# load('../output/inland sands - total abundance models.Rdata')
save(list = ls()[grep('*inland.sands.total.abnd.model', ls())], file = '../output/inland sands - total abundance models.Rdata')
...
write_excel_csv(total.abnd.comparison, file = '../output/Reptiles total abundance models of reptiles - AIC comparison.csv')
...
ggsave('../output/inland.sands.total.abnd.model6 seasonal Predictions and observations in reptile total abundance in Inland Sands.png')
```
...
# Export these graphs:
png('../output/Loess species richness model 4 QQ Plot.png')
plot(loess.sp.rich.sim.res)
dev.off()

png('../output/Loess species richness model 4 fitted vs. scaled residuals.png')
plot(loess.sp.rich.sim.res$fittedPredictedResponse, loess.sp.rich.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nLoess species richness model 4')
dev.off()

png('../output/Loess species richness model 4 fitted vs. residuals.png')
plot(fitted(loess.sp.rich.model4), residuals(loess.sp.rich.model4), main = 'Response scale residuals\nLoess species richness model 4')
dev.off()
```
...
```{r}
file.remove('../output/Loess - species richness model selection.txt')
for (model in c(ls()[grep('*loess.sp.rich.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                 file = '../output/Loess - species richness model selection.txt', append = T)
}
# load('output/Inner sands - Species richness models.Rdata')
save(list = ls()[grep('*loess.sp.rich.model', ls())], file = '../output/Inner sands - Species richness models.Rdata')
...
# Export these graphs:
png('../output/Loess total abundance model 4 QQ Plot.png')
plot(loess.abnd.sim.res)
dev.off()

png('../output/Loess total abundance model 4 fitted vs. scaled residuals.png')
plot(loess.abnd.sim.res$fittedPredictedResponse, loess.abnd.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nLoess total abundance model 4')
dev.off()

png('../output/Loess total abundance model 4 fitted vs. residuals.png')
plot(fitted(loess.abnd.model.full.NB), residuals(loess.abnd.model.full.NB), main = 'Response scale residuals\nLoess total abundance model 4')
dev.off()
```
Back up and document all the Loess total abundance models:
```{r}
file.remove('../output/Loess - total abundance model selection.txt')
for (model in c(ls()[grep('*loess.sp.rich.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                 file = '../output/Loess - total abundance model selection.txt', append = T)
}
# load('../output/Inner sands - total abundance models.Rdata')
save(list = ls()[grep('*loess.abnd.model', ls())], file = '../output/Loess - total abundance models.Rdata')
...
write_excel_csv(total.abnd.comparison, file = '../output/Total abundance models of reptiles - AIC comparison.csv')
...
ggsave('../output/loess.total.abnd.model3 diel Predictions and observations in reptile total abundance.png', scale = 1.25)
```
...
# Export these graphs:
png('../output/Forest species richness model 4 QQ Plot.png')
plot(forest.sp.rich.sim.res)
dev.off()

png('../output/Forest species richness model 4 fitted vs. scaled residuals.png')
plot(forest.sp.rich.sim.res$fittedPredictedResponse, forest.sp.rich.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nForest species richness model 4')
dev.off()

png('../output/Forest species richness model 4 fitted vs. residuals.png')
plot(fitted(Forest.sp.rich.model2), residuals(Forest.sp.rich.model2), main = 'Response scale residuals\nForest species richness model 4')
dev.off()
```
...
save(list = ls()[grep('*Forest.sp.rich.model', ls())], file = '../output/Forest reptile species richness models.Rdata')
...
# Export these graphs:
png('../output/Forest total abundance model 3 QQ Plot.png')
plot(forest.abnd.sim.res)
dev.off()

png('../output/Forest total abundance model 3 fitted vs. scaled residuals.png')
plot(forest.abnd.sim.res$fittedPredictedResponse, forest.abnd.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nForest total abundance model 3')
dev.off()

png('../output/Forest total abundance model 3 fitted vs. residuals.png')
plot(fitted(Forest.abnd.model3), residuals(Forest.abnd.model3), main = 'Response scale residuals\nForest total abundance model 3')
dev.off()
```
...
```{r}
file.remove('../output/Planted Conifer Forest - total abundance model selection.txt')
for (model in c(ls()[grep('*Forest.abnd.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                 file = '../output/Planted Conifer Forest - total abundance model selection.txt', append = T)
}
# load('output/Planted Conifer Forest - total abundance models.Rdata')
save(list = ls()[grep('*Forest.abnd.model', ls())], file = '../output/Planted Conifer Forest - total abundance models.Rdata')
...
write_excel_csv(total.abnd.comparison, file = '../output/Planted Conifer Forest total abundance models of reptiles - AIC comparison.csv')
...
ggsave('../output/Forest.abnd.model3 Predictions and observations in reptile total abundance in Forest with seasonal pattern.png')
...
ggsave('../output/Forest.abnd.model3 Predictions and observations in reptile total abundance in Forest at May 1st.png')
...
# Export these graphs:
png('../output/Sfar species richness null model QQ Plot.png')
plot(sfar.sp.rich.sim.res)
dev.off()

png('../output/Sfar species richness null model fitted vs. scaled residuals.png')
plot(sfar.sp.rich.sim.res$fittedPredictedResponse, sfar.sp.rich.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nSfar species richness null model')
dev.off()

png('../output/Sfar species richness null model fitted vs. residuals.png')
plot(fitted(sfar.sp.rich.model.null), residuals(sfar.sp.rich.model.null), main = 'Response scale residuals\nSfar species richness null model')
dev.off()
```

```{r}
file.remove('../output/sfar - species richness model selection.txt')
for (model in c(ls()[grep('*sfar.sp.rich.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                 file = '../output/sfar - species richness model selection.txt', append = T)
}
# load('output/sfar - Species richness models.Rdata')
save(list = ls()[grep('*sfar.sp.rich.model', ls())], file = '../output/Sfar - Species richness models.Rdata')
...
# Export these graphs:
png('../output/Sfar total abundance model QQ Plot.png')
plot(sfar.abnd.sim.res)
dev.off()

png('../output/Sfar total abundance model fitted vs. scaled residuals.png')
plot(sfar.abnd.sim.res$fittedPredictedResponse, sfar.abnd.sim.res$scaledResiduals, main = 'DHARMa scaled residuals\nSfar total abundance model')
dev.off()

png('../output/Sfar total abundance model fitted vs. residuals.png')
plot(fitted(sfar.sp.rich.model.null), residuals(sfar.sp.rich.model.null), main = 'Response scale residuals\nSfar total abundance model')
dev.off()
```
No problems detected. Now we can back up and document the model selection process:
```{r}
file.remove('../output/sfar - total abundance model selection.txt')
for (model in c(ls()[grep('*sfar.abnd.model', ls())])){
  capture.output(cat(model), cat('\n=========\n'), summary(get(model)), cat('\n=========\n'),
                 file = '../output/sfar - total abundance model selection.txt', append = T)
}
# load('output/sfar - Species richness models.Rdata')
save(list = ls()[grep('*sfar.abnd.model', ls())], file = '../output/sfar - total abundance models.Rdata')
...
Look for correlation in the numeric predictors:
```{r}
# GGally::ggpairs(Loess.env[, .(sin.dist.21.June, sin.dist.noon, cos.dist.21.June, cos.dist.noon, year.count)])
```
Although there are some significant correlations, none of them is strong (> 0.6). So we will keep all of them in the output. Proceed to modelling with GLLVM. First, let's find out what is the best number of latent variables in our data set:
