...
army.bases <- st_read("data/GIS/Army_camps_Harel_Dan/Fenced_15_11.shp") # To calculate distance to nearest army base
...
species.list <- read_excel('data/raw/Reptile_species_traits.xlsx', sheet = 'to_import') %>% as.data.table()
